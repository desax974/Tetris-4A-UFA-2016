...
public class Game {
	...
	public void nextPiece() {
		...
		case 1: {
			this.nextPiece = new L(
					(int) (Math.random() * (this.width - 4) + 2.0), 2);
			break;
		}
		case 2: {
			this.nextPiece = new S(
					(int) (Math.random() * (this.width - 4) + 2.0), 2);
			break;
		}
		case 3: {
		...
		case 4: {
			this.nextPiece = new T(
					(int) (Math.random() * (this.width - 4) + 2.0), 2);
			break;
		}
		case 5: {
			this.nextPiece = new Sinv((int) (Math.random()
					* (this.width - 4) + 2.0), 2);
			break;
		}
		case 6: {
			this.nextPiece = new Linv((int) (Math.random()
					* (this.width - 4) + 2.0), 2);
			break;
		}
		default: {
	...
	public void testScore() {
		new HighScoreFrame(this.score, this.niveau, this.ligne);
	}
